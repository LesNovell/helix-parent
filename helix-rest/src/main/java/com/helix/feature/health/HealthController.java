...
public class HealthController {
    ...
    private final com.helix.feature.health.OfflineProcessor<Multimap<String,String>> offlineProcessor;
     ...
     */
    public HealthController(com.helix.feature.health.OfflineProcessor<Multimap<String,String>> offlineProcessor, ResourceLocator resourceLocator, Clock clock) {
    ...
    private int httpStatusCode() {
        return com.helix.feature.health.Status.INSTANCE.isOnline() ? com.helix.feature.health.Status.SUCCESS : com.helix.feature.health.Status.FORCED_DOWN;
    }
