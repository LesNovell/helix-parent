 ...
 */
public class QueryParameterOfflineProcessor implements com.helix.feature.health.OfflineProcessor<Multimap<String,String>> {
    ...
    public void processInstruction(Multimap<String, String> queryParameters) {
        ...
        if (passwordMatch) {
            queryParameters.entries().stream().filter(queryParam ->
                ...
                com.helix.feature.health.Status.INSTANCE.setOffLine();
            });
            ...
            queryParameters.entries().stream().filter(queryParam ->
                ...
                com.helix.feature.health.Status.INSTANCE.setOnLine();
            });
        }
    }
}
